              ...
              {item?.subMenu ? (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      transform: showCatMenu ? 'translateY(0)' : 'translateY(5px)',
                      scale: showCatMenu ? 1 : 0,
                      opacity: showCatMenu ? 1 : 0,
                      transition: 'transform 0.2s ease-in-out , opacity 0.4s ease-in-out', // Separate transition for opacity with delay
                    }}
                  >
                      ...
                      <div className="bg-white rounded-lg pb-2 mt-4 transition-all ease-in-out text-gray-800 tracking-wide  w-full shadow-lg border border-t-2 border-amber-500">
                        {servicesData?.map((subItem, index) => (
                          ...
                          >
                            ...
                            >
                              <Image src={subItem.logo} alt="header icon" width={25} height={25} />
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      transform: showContactMenu ? 'translateY(0)' : 'translateY(5px)',
                      ...
                      <div className="bg-white rounded-lg pb-2 mt-4 transition-all ease-in-out text-gray-700 w-full shadow-lg border border-t-2 border-amber-500">
                        ...
                        {ftwzData?.map((contactItem, index) => (
                          ...
                          >
                            ...
                            >
                              <Image src={contactItem?.logo} alt="header icon" width={25} height={25} />
                ...
                <div
                  className={`relative ${item.name === "About Us" && "-mb-1"} cursor-pointer font-[400] text-[15px] transition-all ease-in-out border-b-1 ${isActive
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-1/2 h-[2px] bg-amber-600 transition-all ease-in-out duration-500 transform -translate-x-1/2 ${isActive
