      ...
      <div className="relative px-4 py-16 mx-auto">
        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-[35%,60%] justify-center sjcontainer mx-auto">
          <div className="relative order-2 lg:order-1">
            ...
            <div
              data-aos="fade-right"
              className="absolute -left-12 -bottom-10 z-20 p-2 rounded-3xl"
            >
            ...
            <div className="absolute -left-20 -top-10 z-20 rounded-3xl">
              <div
                data-aos="zoom-in"
                className="flex max-md:hidden items-end space-x-2"
              >
                <img
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <img
                  ...
                  alt="Brubish Analytics Dashboard Preview"
          ...
          <div data-aos="fade-up" className="order-1 lg:order-2">
            <div className="space-y-6">
              ...
              <Heading
                className="text-left"
                title="Data-Driven Logistics & Marketing Solutions"
              />

              {/* Description */}
              <p className="text-base text-gray-600 font-[500] text-muted-foreground">
                At Book My Logistics, we understand that seamless supply chain
                management and customer trust are key to success. Our advanced
                marketing strategies and technological solutions empower
                businesses worldwide to optimize logistics and grow their reach
                effectively.
              </p>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-sm md:text-lg">
                    Benefit from our cost-effective and scalable logistics
                    solutions.
                  </span>
                </li>
              </ul>
