  ...
  return (
    ...
    <div className={`flex  sjcontainer flex-col-reverse   md:flex-row items-center w-full `}>
        ...
        <span className='text-sm text-left md:text-base font-bold py-1.5  text-gray-500 uppercase '>
              ...
              <Subheading className='text-left my-1' title='Comprehensive Logistics Solutions, Tailored Just for You' />
<div className="relative inline-block mt-3 lg:hidden font-medium group">
    <Image
        src="/services/vas/2.png"
        alt="BML services banner"
...
<div className='text-sm md:text-base text-gray-600 duration-300 mt-4 mb-7'>
    At Book My Logistics (BML), we go beyond traditional logistics. Our value-added services include Customs Brokerage, Trade Finance Solutions, Real-Time Tracking, and Cargo Insurance. Whether you're managing complex trade routes or need streamlined order management, we ensure that every aspect of your logistics journey is handled with precision. Experience the difference of a logistics partner who cares about efficiency and transparency at every step.
</div>
        </div>
