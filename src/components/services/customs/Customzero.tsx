  ...
  return (
    ...
    <div className={`flex  sjcontainer flex-col-reverse   md:flex-row items-center w-full `}>
        ...
        <span className='text-sm text-left md:text-base font-bold py-1.5  text-gray-500 uppercase '>
              ...
              <Subheading className='text-left' title='Unlock Exclusive Savings with BML Fulfillment Services
' />
  ...
  At Book My Logistics (BML), we offer flexible and affordable financing solutions designed to empower businesses with the working capital they need to grow. BML Finance provides unsecured BML Finance and cash flow management options, tailored specifically for SMEs. With quick approvals, competitive interest rates, and no collateral required for unsecured loans, we help businesses secure their operations without added financial stress.
</div>
