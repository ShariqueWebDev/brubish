...
const Truckingsectionthree = () => {
  return (
    ...
    <div className={`flex  sjcontainer flex-col-reverse   md:flex-row items-center w-full `}>
        ...
        <div class="relative   lg:inline-block hidden overflow-hidden font-medium group">
        ...
        <span className='text-sm text-left md:text-base font-bold py-1.5  text-gray-500 uppercase '>
            ...
            <p className='text-xl text-left md:text-3xl py-1.5  text-primary '>
                Shopify Merchants Can Save up to $1 Million with BML Fulfillment
            </p>
            ...
            <div
                ...
                As Shopify's official logistics partner, BML wants to help merchants ship faster, and accelerate their sales! Shopify merchants who are not currently using BML Fulfillment, can save 15% off their fulfillment services (up to $1 Million) through December 2024.* Start saving and scale your business today!
            </div>
    ...
    <div className={`flex  sjcontainer flex-col-reverse  mt-10 md:mt-20  md:flex-row items-center w-full `}>
        {/* Text Section */}
        ...
        <span className='text-sm text-left md:text-base font-bold py-1.5  text-gray-500 uppercase'>
            ...
            <div
                className='text-sm md:text-base text-gray-600 duration-300  mt-4 mb-6' >
                As Shopify's official logistics partner, BML wants to help merchants ship faster, and accelerate their sales! Shopify merchants who are not currently using BML Fulfillment, can save 15% off their fulfillment services (up to $1 Million) through December 2024.* Start saving and scale your business today!
            </div>
            <div
                className='text-sm md:text-base text-gray-600 duration-300  mt-4 mb-6' >
        ...
        <div class="relative  overflow-hidden   lg:inline-block hidden font-medium group">
