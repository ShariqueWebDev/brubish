      ...
      <div className=" my-8 md:my-16">
        <div className="bg-gray-800 text-white">
          <div className="sjcontainer text-center py-8 md:py-16 mb-10">
            ...
            <p className=" text-base md:text-xl leading-8 text-balance ">
              Book on-ground transportation for your cargo to and from all major
              inlands and ports across India for FTL and LTL volumes as well as
              special types of transport like reefers and Over Dimensional Cargo
              (ODC)
            </p>
          </div>
        </div>
        ...
        <div className='bg-[url("/services/trucking/bg1.webp")]'>
          <div
            className={` sjcontainer  py-8 md:py-24  md:grid grid-cols-2 max-md:space-y-6 items-center`}
          >
            <div>
              <Image
                src="/services/trucking/30.png"
                alt="trucking"
                width={800}
                height={550}
                className="w-full max-w-[300px] md:max-w-[600px] mx-auto"
              />
            </div>
            <div>
              ...
              <p className="text-gray-600 font-light my-3">
                Track and trace your shipments easily and
                <br className="max-md:hidden" /> let go all of your shipping
                stress by using Brubish
              </p>
              <div className="mt-4">
                <span className=" rounded-xl bg-secondary px-6 py-3">
                  Ship With Us{" "}
                </span>
              </div>
            </div>
