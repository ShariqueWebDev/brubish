...
const data = [
  {
    ...
    description:
      "Get quotes around the clock in different countries and regions",
    list: [
    ...
    image: "/services/freight/frieght-1.webp",
    icon: "",
  },
  {
    title: "Unlock Competitive Pricing & Solutions",
    description:
      "Ensuring you receive the best possible value for your shipment",
    list: [
    ...
    image: "/services/freight/frieght-2.webp",
    icon: "",
  },
  {
    title: "Tailor your Quote",
    description:
      "Click Custom Quote, our local dedicated team will get you one",
    list: [
  ...
  return (
    <div className="py-8  md:py-16  sjcontainer">
      ...
      <p className="text-base text-gray-700 text-center mt-4 ">
        We take pride in our logistics expertise and professionalism, our
        freight forwarding service provides a seamless experience for all
        shipping needs for SMEs, start-ups and businesses of all kinds. Get
        instant quotes and manage your global shipments with ease.
      </p>
        ...
        <div className="mx-auto">
          {data?.map((item, index) => {
            return (
              <div
                key={index}
                className={` my-16 flex justify-between flex-row ${
                  index % 2 == 0 && "flex-row-reverse "
                } items-center`}
              >
                <div className="relative max-md:mx-4 lg:inline-block  overflow-hidden rounded-xl hidden font-medium group flex-1">
                  <Image
                    src={item.image}
                    alt="banner"
                ...
                <div className=" md:p-8 flex-1 group">
                  ...
                  <div className="  my-4 lg:hidden font-medium group md:min-h-[300px] md:max-w-[500px] overflow-hidden">
                    <Image
                      src={item.image}
                      alt="banner"
                  ...
                  <div className="text-base md:text-base text-gray-600 duration-300 group-hover:text-black mt-4 mb-6">
                    {item.description}
                  </div>
                  <div>
                    {item.list?.map((listItem, index) => {
                      return (
                        <div
                          key={index}
                          className="text-sm flex items-center gap-2 md:text-base text-amber-500 duration-300 mb-2"
                        >
                          <FaCheckSquare className="min-w-4" />
                          {listItem}
                        </div>
                      );
                    })}
