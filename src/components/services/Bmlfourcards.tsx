  ...
  return (
    <div className="bg-gray-50 ">
      <div className="sjcontainer py-16 md:py-24">
        <Heading title="Brubish Insurance Services" className="text- mb-2" />
        <div className="text-sm md:text-base max-w-[1000px] mt-2 mb-8">
          At Brubish, we offer a range of comprehensive insurance services
          designed to protect your cargo and assets during every step of the
          logistics process. Our insurance solutions are tailored to provide
          peace of mind, ensuring the safety and security of your goods, no
          matter the journey.
        </div>
        ...
        <div className="grid grid-cols-2  lg:grid-cols-4 gap-x-4 gap-y-4 md:gap-8 mt-2 ">
          {data?.map((section, index) => {
            ...
            return (
              <div
                className={`border text-center shadow-md h-full flex flex-col`}
                key={index}
                style={{ borderColor }}
              >
                <h3
                  className={`relative ${bgcolor} text-white py-2 font-bold text-base md:text-lg`}
                >
                  {section.title}
                  <span
                    style={{
                ...
                <div
                  className="text-sm md:text-base text-gray-600 p-1 md:p-4 pt-6 bg-white flex-grow"
