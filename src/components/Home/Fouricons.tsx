...
const data = [
  ...
  },
  {
    ...
    content:
      "With Brubish Customs, our expert brokers can help you clear goods quickly, minimize import duties, and leverage customs data to benefit your entire supply chain. We'll work with you even if you don’t ship with us.",
  },
  {
    id: 3,
    name: "Trucking",
  ...
  },
  {
    ...
    content:
      "Brubish Fulfillment provides fast, reliable DTC and B2B fulfillment. We make it easy to sell in more places with our 30+ eCommerce and retailer integrations. Plus, our Seller Portal gives you end-to-end visibility and control.",
  },
];
