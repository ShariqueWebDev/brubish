  ...
  return (
    <div className="relative w-full max-sm:py-10  max-lg:py-16 lg:h-[90vh]">
      ...
      <div className="relative sjcontainer z-10 flex flex-col lg:grid lg:grid-cols-2 xl:grid-cols-[55%,45%] space-x-0 lg:space-x-20 items-center justify-between h-full px-6 lg:px-12">
        ...
        <div data-aos="fade-up" data-aos-duration="400" className="text-white space-y-4 flex-1 order-2 lg:order-none text-center lg:text-left">
          ...
          <div data-aos="zoom-in" className="bg-white/50  lg:hidden rounded-md p-1.5 order-1 lg:order-none lg:w-[60%] max-w-[450px]  mx-auto lg:mx-0">
          <Image
          ...
          <p className="text-sm lg:text-base text-white font-[500]">
            BML is a tech enabled platform aiming to transform SME's into large business with its end-to-end supply chain solutions
          </p>
        ...
        <div   data-aos="zoom-in" className="bg-white/50 rounded-md max-lg:hidden p-1.5 order-1 lg:order-none  max-w-[450px]   mx-auto lg:mx-0">
          <Image
            src="/banner-assets.png"
            width={400}
            height={400}
