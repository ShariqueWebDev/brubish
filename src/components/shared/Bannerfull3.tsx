...
const Bannerfull3 = ({ title, bgImg, icon,description,page }) => {
  return (
    <div className="relative">
      <div
        className="bg-bottom  text-white py-12 md:py-20 object-cover relative"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center relative z-10 pt-[10vh]">
