...
export default function NDRFTWZBenefits() {
  const sections = [
    {
      title: 'BML FTWZ FOR GLOBAL SUPPLY INNOVATIONS - QUICK LOOK',
      content: [
        {
    ...
    {
      title: 'BML FTWZ OTHER MISCELLANEOUS BENEFITS - QUICK LOOK',
      content: [
        {
          heading: 'General',
          items: [
...
<div>
        ...
        <Ftwzbanner title="FTWZ For consolidation" bgImg="/about/about.jpg" />
        ...
        <div key={idx} className="mb-16">
          ...
          {section.content.map((content, idx) => (
            <div key={idx} className="mb-8">
              <h3 className="font-semibold text-lg mb-4">{content.heading}</h3>
