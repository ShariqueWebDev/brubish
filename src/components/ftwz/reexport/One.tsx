...
const One = () => {
  return (
    ...
    <div className=' sjcontainer py-8 md:py-16'>
      ...
      <Heading className='  p-4 lg:hidden' title="Features of Free Trade Warehousing Zone for Re-exports" />
        <div data-aos="fade-right" className=' h-[300px] md:h-[500px]'>
<Image src="/ftwz/reexport/1.png" alt="indian importers" width={1000} height={1000} className="w-full h-full !object-cover" />
          </div>
          <div className=' '>
            <Heading title="Features of Free Trade Warehousing Zone for for Re-exports" className="mb-3 max-lg:hidden" />
            ...
            {customsDutiesData.map((item, index) => (
              <li key={index} data-aos="fade-left" className="flex text-sm   text-gray-700 items-center space-x-2  duration-200">
