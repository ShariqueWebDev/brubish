...
export default function Twoforeignexport() {
  const features = [
    {
      ...
      description: "Warehouses tailored to accommodate various types of products."
    },
    {
      icon: Globe,
      title: "Quick Start for Foreign Businesses",
      description: "Foreign entities can begin Exim operations in India within 1-2 days by registering with BML FTWZ."
    },
    {
      icon: Package,
      title: "Simplified Customs Clearance",
      description: "One-stop resource for seamless import and export customs clearance."
    },
    {
      icon: CreditCard,
      title: "Deferred Duty Payments",
      description: "Flexible payment terms for customs duties as per importer/consignee requirements."
    },
    {
      icon: Eye,
      title: "Temporary Cargo Removal",
      description: "Cargo can be temporarily removed for exhibitions or demonstrations without paying customs duties and returned within 120 days."
    },
    {
      icon: Truck,
      title: "Cost-Effective & Timely Delivery",
      description: "Efficient and economical shipment delivery to customers, meeting timelines."
    }
  ]
  ...
  return (
    ...
    <Heading className='' title='Advantages of Using BML FTWZ
' />
      </div>
