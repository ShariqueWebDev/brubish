...
const One = () => {
  return (
    ...
    <Subheading className=' mb-2 lg:hidden  ' title="Features of Free Trade Warehousing Zone for Exporters"/>
      <div data-aos="fade-right" className=' h-[300px] md:h-[500px]'>
<Image src="/ftwz/indian-exporters/1.png" alt="indian importers" width={1000} height={1000} className="w-full h-full !object-cover" />
        </div>
        <div className='  '>
          <Heading className=' max-lg:hidden text-xl md:text-3xl' title="Features of Free Trade Warehousing Zone for Indian Exporters" />
