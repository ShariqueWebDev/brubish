...
const Two = () => {
  return (
    <div className='sjcontainer my-12 md:my-24'>
      ...
      <div className='mt-4'>
        <p className='font-[400] text-gray-500 text-base md:text-2xl'>Some of the accruing tangible advantages for imports through BML FTWZ into India are listed as below</p>
