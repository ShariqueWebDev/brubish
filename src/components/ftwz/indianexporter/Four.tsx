...
const Four = () => {
  return (
    ...
    <div>
      <Subheading className='text-center  mb-6' title="FTWZ based Supply Chain (Exports) - Process
" />
  <Image src="/ftwz/importer7.png" alt="fig" width={1400} height={700} className=" " />
    
    <div className='grid sm:grid-cols-[35%,65%] sm:space-x-8 max-w-[1000px] mt-10  mx-auto'>
      <Subheading title='A Paradiagram Shift for Indian Exports' className='m-auto text-center'/>
