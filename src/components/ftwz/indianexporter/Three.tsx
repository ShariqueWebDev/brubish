...
const Three = () => {
  return (
    <div className='px-4'>
      ...
      <Image src="/ftwz/3.png" className='mx-auto w-full max-w-[1200px]' alt="" width={1600} height={1000} />
      </div>
      ...
      <Image src="/ftwz/4.png" className='mx-auto w-full max-w-[1200px]' alt="" width={1600} height={1000} />
      </div>
    </div>
  )
}
