...
const data = [
    {
        column1: "BML FTWZ",
        column2: "BML Free Trade Warehouse",
    ...
    },
    {
        ...
        column2: "Since the FTWZ is a Deemed Port the goods are NOT assessed for Duty. A Bill of Entry for home consumption is filed with FTWZ Unit for transfer of goods from Airport/Seaport to FTWZ.",
        column3: "Bill of Entry for Warehousing is filed and assessed for Duty before being permitted to move to the Bonded Warehouses.",
        column4: "Goods assessed and duty levied immediately upon import."
    },
    {
        column1: "Multi-Country Consolidation",
        column2: "Consolidation of goods from Multi-Country permitted as per customer’s requirement.",
    ...
    },
    {
        ...
        column2: "Goods are transported from customs gateway to BML FTWZ via transshipment procedure without assessment by Customs in turn decreasing Customs process lead time.",
        column3: "Movement of goods into the bonded warehouse are subject to assessment at Gateway Customs.",
        column4: "Standard customs assessment at entry."
    },
    {
        column1: "Value Added Services (VAS)",
        column2: "Can carry out Value Added Services as provided for SEZ Rule 18 (5)",
        column3: "Value Added Services are permitted, subject to Customs permission in advance of any such activities.",
    ...
    },
    {
        ...
        column3: "Goods can enter Bonded Warehouse pending Production of import license.",
    ...
    },
    {
        ...
        column2: "SEZ Rule 37 permits the goods to be kept until the Validity of the Unit Holder. The goods in the FTWZ are not assessed for Duty.",
        column3: "One Year, further extension allowed subject to approval from Chief Commissioner of Customs.",
    ...
    },
    {
        ...
        column3: "SAD benefit applicable as per Customs notifications for pre-packed goods only.",
    ...
    },
    {
        ...
        column3: "Dedicated customs setup could be done subject to approval from Customs office.",
        column4: "Standard customs setup applies."
    },
    {
        column1: "Customs procedure for Removal of Goods",
        column2: "Hassle-Free procedure for removal of goods from FTWZ to DTA. Customs processing done within the FTWZ zone.",
        column3: "All customs processing with the customs house located away from the bonded facility.",
        column4: "Standard removal procedures."
    },
    {
        column1: "Compliance of Allied Acts",
        column2: "Payment of duty and compliance of allied acts, only when the goods move out of FTWZ into DTA",
        column3: "Payment of duty at the time of removal of goods along with applicable interest & upon production of applicable import license.",
        column4: "Compliance with allied acts required at entry."
    },
    {
        column1: "Ease of EXIM Trade",
        column2: "Hassle-Free Procedure for re-exports and re-import unlike standard customs procedure.",
        column3: "Re-imports and re-exports go through standard customs approval procedures.",
        column4: "Standard import/export procedures."
    },
    {
        column1: "Regional Trade Hubs",
        column2: "Possibility of using this facility as a regional hub. Permits operations of VMI model with Foreign Currency models.",
        column3: "Cannot be used as a regional hub since no facilities are available for export of goods and only INR transactions are permitted within a bonded warehouse.",
    ...
    },
    {
        ...
        column3: "Custom Bonded Warehouse Bank guarantee required for every shipment; Bond to be executed for 2x customs duty ",
    ...
    },
    {
        ...
        column4: "Customs to be paid immediatelyhence NA Double insurance not applicable"
    },
    {
        column1: "GST on Ocean Freight, Inbound Logistics (incl de-bulking and SKU wise stocking)",
    ...
    },
    {
        ...
        column2: "Exempt",
        column3: "For the Bond executed, manual records must be kept for 8 years, and the cancellation process is tedious",
        column4: "NA"
    },
    {
        column1: "High sea sales risk mitigation",
        column2: "Clients can sell the cargo after it lands on the port as it is still considered as foreign territory",
        column3: "Clients cannot sell the cargo after it lands on the port as it is still considered as foreign territory",
        column4: "Clients cannot sell the cargo after it lands on the port as it is still considered as foreign territory"
    },
    {
    ...
    },
    {
        ...
        column2: "As FTWZ comes under SEZ Act, sales to SEZS, EOUS is easy to execute",
        column3: "CRHS come under Ministry of Finand sales to SEZS, EOUS is difficult",
...
const Ftwz3 = () => {
  return (
    <div className='my-8  md:my-20 sjcontainer'>
            <Subheading className='mb-4' title='Benefits of BML Free Trade Warehousing Zone (FTWZ) Over CBWH or DTA warehouse' />
