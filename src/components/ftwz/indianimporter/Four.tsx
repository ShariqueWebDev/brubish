...
const Four = () => {
  return (
    ...
    <div>
      <Subheading className='text-center mt-10 mb-6' title="FTWZ based Supply Chain (Imports) - Process
" />
  <Image src="/ftwz/importer3.png" alt="fig" width={1400} height={700} className="" />
  <div className='grid sm:grid-cols-[35%,65%] sm:space-x-8 max-w-[1000px] mt-10  mx-auto'>
      <Subheading title="A Sea Change for Indian Efficiency" className=' m-auto text-center' />
      <div>
        {
