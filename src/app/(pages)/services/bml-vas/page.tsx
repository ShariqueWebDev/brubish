...
const Page = () => {
  return (
    <div className=''>
     <Servicebanner3
      icon="/services/vas/banner.svg" heading="BML VAS" title="More Than Logistics" description="BML’s value-added services include packaging, labeling, and quality checks. Tailored solutions for your business needs." buttontext="Get Started" buttonlink="/services" bannerImage="/services/vas/1.png"
      />
