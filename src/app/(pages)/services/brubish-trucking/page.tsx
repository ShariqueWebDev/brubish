...
const Page = () => {
  return (
    <div>
      <Servicebanner3
        icon="/services/trucking/t90.svg"
        istrucking={true}
        heading="Brubish Trucking"
        title="Reliable Last-Mile Solutions"
        description="Brubish Trucking ensures timely delivery with a robust fleet and real-time tracking. Reliable transport, anywhere you need."
        buttontext="Get Started"
        buttonlink="/services"
        bannerImage="/bmlgif.gif"
      />
