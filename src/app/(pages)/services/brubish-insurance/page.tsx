...
const Page = () => {
  return (
    <div className="">
      <Servicebanner3
        icon="/services/insurance/banneri.svg"
        heading="Brubish Insurance"
        title="Secure Your Shipments"
        description="Brubish Insurance protects your goods in transit with comprehensive coverage and claims support. Ship with confidence."
        buttontext="Get Started"
        buttonlink="/services"
        bannerImage="/services/insurance/banner.png"
      />
