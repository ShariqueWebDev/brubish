...
const Page = () => {
  return (
    <div className="">
      <Servicebanner3
        icon="/services/customs/z111.svg"
        heading="Brubish Customs"
        title="Simplifying Border Clearance"
        description="Experience hassle-free global trade with Brubish Customs – your trusted partner for seamless customs clearance and compliance."
        buttontext="Get Started"
        buttonlink="/services"
        bannerImage="/services/customs/banner.webp"
      />
